...
#  Created on Mon Nov 10 21:15:32 2025                
#                                                     
#######################################################
...
group_path -name in2reg_tmp.6540 -from {0xcbc 0xcbf} -to 0xcc0 -ignore_source_of_trigger_arc
getOptMode -allowPreCTSClkSrcPaths -quiet
set_global _is_ipo_interactive_path_groups 1
group_path -name in2out_tmp.6540 -from {0xcc3 0xcc6} -to 0xcc7 -ignore_source_of_trigger_arc
set_global _is_ipo_interactive_path_groups 1
group_path -name reg2reg_tmp.6540 -from 0xcc9 -to 0xcca
set_global _is_ipo_interactive_path_groups 1
group_path -name reg2out_tmp.6540 -from 0xccd -to 0xcce
setPathGroupOptions reg2reg_tmp.6540 -effortLevel high
isAnalysisModeSetup
...
reset_path_group -name reg2out_tmp.6540
set_global _is_ipo_interactive_path_groups 0
reset_path_group -name in2reg_tmp.6540
set_global _is_ipo_interactive_path_groups 0
reset_path_group -name in2out_tmp.6540
set_global _is_ipo_interactive_path_groups 0
reset_path_group -name reg2reg_tmp.6540
set_global _is_ipo_interactive_path_groups 0
...
getOptMode -allowPreCTSClkSrcPaths -quiet
set_global _is_ipo_interactive_path_groups 1
group_path -name in2reg_tmp.6540 -from {0xcd8 0xcdb} -to 0xcdc -ignore_source_of_trigger_arc
getOptMode -allowPreCTSClkSrcPaths -quiet
set_global _is_ipo_interactive_path_groups 1
group_path -name in2out_tmp.6540 -from {0xcdf 0xce2} -to 0xce3 -ignore_source_of_trigger_arc
set_global _is_ipo_interactive_path_groups 1
group_path -name reg2reg_tmp.6540 -from 0xce5 -to 0xce6
set_global _is_ipo_interactive_path_groups 1
group_path -name reg2out_tmp.6540 -from 0xce9 -to 0xcea
setPathGroupOptions reg2reg_tmp.6540 -effortLevel high
reset_path_group -name reg2out_tmp.6540
set_global _is_ipo_interactive_path_groups 0
reset_path_group -name in2reg_tmp.6540
...
set_ccopt_property clock_period -pin clk 1.8
...
editPin -pin DFT_sdi_1 -assign {2.5 0.5} -layer 2 -side top
editPin -pin heater_on -assign {0.14 0.3} -layer 2 -side bottom
editPin -pin DFT_sdo_1 -assign {0.6 0.2} -layer 2 -side top
editPin -pin clk -assign {1.0 0.1} -layer 2 -side top
editPin -pin {light_sensor[0]} -assign {0.1 0.6} -layer 2 -side bottom
editPin -pin entry_sensor -assign {1.0 0.1} -layer 2 -side bottom
editPin -pin {volume_cmd[3]} -assign {0.2 0.6} -layer 2 -side bottom
editPin -pin DFT_sdo_2 -assign {1.19 0.6} -layer 2 -side top
...
streamOut HA.gds -mapFile streamOut.map -libName DesignLib -units 2000 -mode ALL
...
set_verify_drc_mode -disable_rules {} -check_ndr_spacing auto -check_only default -check_same_via_cell false -exclude_pg_net false -ignore_trial_route false -ignore_cell_blockage false -use_min_spacing_on_block_obs auto -report HA.drc.rpt -limit 1000
verify_drc
set_verify_drc_mode -area {0 0 0 0}
set_verify_drc_mode -disable_rules {} -check_ndr_spacing auto -check_only default -check_same_via_cell false -exclude_pg_net false -ignore_trial_route false -ignore_cell_blockage false -use_min_spacing_on_block_obs auto -report HA.drc.rpt -limit 1000
verify_drc
set_verify_drc_mode -area {0 0 0 0}
zoomBox 9.71800 -4.12850 99.77400 81.28350
zoomBox 42.99550 -3.10500 98.30200 49.34950
zoomBox 68.31050 -2.32650 97.18200 25.05600
zoomBox 78.97900 -1.99900 96.71000 14.81750
zoomBox 83.85350 -1.50100 96.66450 10.64950
zoomBox 87.37550 -1.14100 96.63200 7.63800
zoomBox 89.92000 -0.88150 96.60850 5.46200
zoomBox 90.91400 -0.78050 96.59950 4.61200
zoomBox 91.75700 -0.69750 96.59000 3.88650
zoomBox 92.47400 -0.62650 96.58200 3.26950
zoomBox 94.04100 -0.47200 96.56400 1.92100
uiSetTool move
selectObject IO_Pin heater_on
moveGroupPins -loc {95.39850 -0.29000}
fit
fit
zoomBox 0.73650 18.25750 94.83050 81.92750
zoomBox -7.42550 11.80600 103.27350 86.71200
zoomBox -28.32400 -4.65800 124.89250 99.01800
zoomBox -16.09850 -0.85250 114.13550 87.27200
zoomBox -5.70700 2.38200 104.99200 77.28800
zoomBox 3.12600 5.13150 97.22000 68.80150
zoomBox 10.63400 7.46850 90.61400 61.58800
zoomBox -16.09850 -0.85250 114.13550 87.27200
zoomBox -42.70750 -9.13500 137.54800 112.83700
saveDesign HA
saveDesign HA
get_verify_drc_mode -disable_rules -quiet
get_verify_drc_mode -quiet -area
...
verify_drc
set_verify_drc_mode -area {0 0 0 0}
zoomBox -3.96950 -7.70100 126.26600 80.42450
zoomBox 44.16000 -5.91550 112.14400 40.08650
zoomBox 69.28250 -4.98400 104.77150 19.03000
zoomBox 79.44150 -3.09200 101.23650 11.65600
zoomBox 81.87100 -2.68750 100.39700 9.84850
zoomBox 87.19300 -1.82050 98.57050 5.87800
zoomBox 91.24150 -1.16150 97.18100 2.85750
zoomBox 88.84250 -1.67750 98.51400 4.86700
zoomBox 84.93600 -2.51800 100.68500 8.13900
zoomBox 78.57450 -3.88600 104.22050 13.46750
zoomBox 68.21600 -6.11350 109.97700 22.14450
zoomBox 51.35000 -9.74000 119.35050 36.27350
zoomBox 23.88550 -15.64550 134.61450 59.28050
zoomBox -20.83500 -25.26100 159.46900 96.74400
zoomBox -74.10600 -37.54050 175.45050 131.32500
zoomBox -27.60700 -28.69250 152.69750 93.31300
zoomBox 30.26050 -17.56850 124.38150 46.11950
zoomBox 60.46750 -11.76300 109.60050 21.48350
zoomBox 78.81950 -8.23550 100.62050 6.51650
zoomBox 85.36650 -5.36250 98.75650 3.69800
zoomBox 90.34750 -3.17650 97.33800 1.55350
moveGroupPins -loc {95.48350 -0.29000}
zoomBox 88.30650 -3.70850 97.98200 2.83850
zoomBox 83.68450 -4.91400 99.44050 5.74750
zoomBox 72.71700 -7.77400 102.90200 12.65100
zoomBox 58.30050 -11.53300 107.45200 21.72600
zoomBox 24.08900 -20.45300 118.25000 43.26200
zoomBox -20.88250 -32.17850 132.44350 71.57150
zoomBox -100.64300 -48.25650 149.02350 120.68350
fit
