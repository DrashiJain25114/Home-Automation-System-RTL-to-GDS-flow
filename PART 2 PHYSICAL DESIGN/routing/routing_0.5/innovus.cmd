...
#  Created on Mon Nov 17 01:22:04 2025                
#                                                     
#######################################################
...
group_path -name in2reg_tmp.15350 -from {0xcbc 0xcbf} -to 0xcc0 -ignore_source_of_trigger_arc
getOptMode -allowPreCTSClkSrcPaths -quiet
set_global _is_ipo_interactive_path_groups 1
group_path -name in2out_tmp.15350 -from {0xcc3 0xcc6} -to 0xcc7 -ignore_source_of_trigger_arc
set_global _is_ipo_interactive_path_groups 1
group_path -name reg2reg_tmp.15350 -from 0xcc9 -to 0xcca
set_global _is_ipo_interactive_path_groups 1
group_path -name reg2out_tmp.15350 -from 0xccd -to 0xcce
setPathGroupOptions reg2reg_tmp.15350 -effortLevel high
isAnalysisModeSetup
...
reset_path_group -name reg2out_tmp.15350
set_global _is_ipo_interactive_path_groups 0
reset_path_group -name in2reg_tmp.15350
set_global _is_ipo_interactive_path_groups 0
reset_path_group -name in2out_tmp.15350
set_global _is_ipo_interactive_path_groups 0
reset_path_group -name reg2reg_tmp.15350
set_global _is_ipo_interactive_path_groups 0
...
getOptMode -allowPreCTSClkSrcPaths -quiet
set_global _is_ipo_interactive_path_groups 1
group_path -name in2reg_tmp.15350 -from {0xcd8 0xcdb} -to 0xcdc -ignore_source_of_trigger_arc
getOptMode -allowPreCTSClkSrcPaths -quiet
set_global _is_ipo_interactive_path_groups 1
group_path -name in2out_tmp.15350 -from {0xcdf 0xce2} -to 0xce3 -ignore_source_of_trigger_arc
set_global _is_ipo_interactive_path_groups 1
group_path -name reg2reg_tmp.15350 -from 0xce5 -to 0xce6
set_global _is_ipo_interactive_path_groups 1
group_path -name reg2out_tmp.15350 -from 0xce9 -to 0xcea
setPathGroupOptions reg2reg_tmp.15350 -effortLevel high
reset_path_group -name reg2out_tmp.15350
set_global _is_ipo_interactive_path_groups 0
reset_path_group -name in2reg_tmp.15350
