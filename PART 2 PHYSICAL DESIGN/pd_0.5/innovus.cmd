...
#  Created on Mon Nov 10 21:39:27 2025                
#                                                     
#######################################################
...
group_path -name in2reg_tmp.16772 -from {0xcbc 0xcbf} -to 0xcc0 -ignore_source_of_trigger_arc
getOptMode -allowPreCTSClkSrcPaths -quiet
set_global _is_ipo_interactive_path_groups 1
group_path -name in2out_tmp.16772 -from {0xcc3 0xcc6} -to 0xcc7 -ignore_source_of_trigger_arc
set_global _is_ipo_interactive_path_groups 1
group_path -name reg2reg_tmp.16772 -from 0xcc9 -to 0xcca
set_global _is_ipo_interactive_path_groups 1
group_path -name reg2out_tmp.16772 -from 0xccd -to 0xcce
setPathGroupOptions reg2reg_tmp.16772 -effortLevel high
isAnalysisModeSetup
...
reset_path_group -name reg2out_tmp.16772
set_global _is_ipo_interactive_path_groups 0
reset_path_group -name in2reg_tmp.16772
set_global _is_ipo_interactive_path_groups 0
reset_path_group -name in2out_tmp.16772
set_global _is_ipo_interactive_path_groups 0
reset_path_group -name reg2reg_tmp.16772
set_global _is_ipo_interactive_path_groups 0
...
getOptMode -allowPreCTSClkSrcPaths -quiet
set_global _is_ipo_interactive_path_groups 1
group_path -name in2reg_tmp.16772 -from {0xcd8 0xcdb} -to 0xcdc -ignore_source_of_trigger_arc
getOptMode -allowPreCTSClkSrcPaths -quiet
set_global _is_ipo_interactive_path_groups 1
group_path -name in2out_tmp.16772 -from {0xcdf 0xce2} -to 0xce3 -ignore_source_of_trigger_arc
set_global _is_ipo_interactive_path_groups 1
group_path -name reg2reg_tmp.16772 -from 0xce5 -to 0xce6
set_global _is_ipo_interactive_path_groups 1
group_path -name reg2out_tmp.16772 -from 0xce9 -to 0xcea
setPathGroupOptions reg2reg_tmp.16772 -effortLevel high
reset_path_group -name reg2out_tmp.16772
set_global _is_ipo_interactive_path_groups 0
reset_path_group -name in2reg_tmp.16772
...
verify_drc
set_verify_drc_mode -area {0 0 0 0}
zoomBox 10.06500 -4.90650 126.13750 105.18050
zoomBox 39.90250 -3.60150 123.76500 75.93650
zoomBox 69.87850 -2.29100 121.38150 46.55600
zoomBox 88.37800 -1.53900 120.00700 28.45900
zoomBox 99.95350 -1.20200 119.37750 17.22050
zoomBox 107.32400 -0.88500 119.25300 10.42900
zoomBox 111.85050 -0.67650 119.17700 6.27200
zoomBox 114.63050 -0.54700 119.13050 3.72100
zoomBox 116.33800 -0.46450 119.10200 2.15700
uiSetTool move
selectObject IO_Pin heater_on
moveGroupPins -loc {118.00050 -0.29000}
saveDesign HA
saveDesign HA
get_verify_drc_mode -disable_rules -quiet
get_verify_drc_mode -quiet -area
