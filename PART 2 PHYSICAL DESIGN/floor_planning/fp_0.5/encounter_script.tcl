...
init_design     #runs the design initialization using all the inputs you just set.

setDesignMode -process 90 -flowEffort standard  #sets the process node to 90nm and standard PnR flow effort for the run
