...
#  Created on Fri Nov 14 20:36:01 2025                
#                                                     
#######################################################
...
group_path -name in2reg_tmp.31082 -from {0xcbc 0xcbf} -to 0xcc0 -ignore_source_of_trigger_arc
getOptMode -allowPreCTSClkSrcPaths -quiet
set_global _is_ipo_interactive_path_groups 1
group_path -name in2out_tmp.31082 -from {0xcc3 0xcc6} -to 0xcc7 -ignore_source_of_trigger_arc
set_global _is_ipo_interactive_path_groups 1
group_path -name reg2reg_tmp.31082 -from 0xcc9 -to 0xcca
set_global _is_ipo_interactive_path_groups 1
group_path -name reg2out_tmp.31082 -from 0xccd -to 0xcce
setPathGroupOptions reg2reg_tmp.31082 -effortLevel high
isAnalysisModeSetup
...
reset_path_group -name reg2out_tmp.31082
set_global _is_ipo_interactive_path_groups 0
reset_path_group -name in2reg_tmp.31082
set_global _is_ipo_interactive_path_groups 0
reset_path_group -name in2out_tmp.31082
set_global _is_ipo_interactive_path_groups 0
reset_path_group -name reg2reg_tmp.31082
set_global _is_ipo_interactive_path_groups 0
...
getOptMode -allowPreCTSClkSrcPaths -quiet
set_global _is_ipo_interactive_path_groups 1
group_path -name in2reg_tmp.31082 -from {0xcd8 0xcdb} -to 0xcdc -ignore_source_of_trigger_arc
getOptMode -allowPreCTSClkSrcPaths -quiet
set_global _is_ipo_interactive_path_groups 1
group_path -name in2out_tmp.31082 -from {0xcdf 0xce2} -to 0xce3 -ignore_source_of_trigger_arc
set_global _is_ipo_interactive_path_groups 1
group_path -name reg2reg_tmp.31082 -from 0xce5 -to 0xce6
set_global _is_ipo_interactive_path_groups 1
group_path -name reg2out_tmp.31082 -from 0xce9 -to 0xcea
setPathGroupOptions reg2reg_tmp.31082 -effortLevel high
reset_path_group -name reg2out_tmp.31082
set_global _is_ipo_interactive_path_groups 0
reset_path_group -name in2reg_tmp.31082
...
fit
fit
zoomBox 27.18700 17.31950 125.84850 110.89350
zoomBox 41.08650 26.31350 124.94900 105.85150
zoomBox 70.88450 45.50250 122.38700 94.34950
zoomBox 77.99750 50.08350 121.77500 91.60350
zoomBox 93.55200 60.10000 120.43750 85.59900
zoomBox 97.26550 62.49150 120.11800 84.16550
zoomBox 70.93600 45.85550 122.44000 94.70350
zoomBox 27.59600 18.49550 126.26200 112.07400
zoomBox -29.37650 -17.38700 131.28600 134.99100
zoomBox -55.43150 -33.78250 133.58350 145.48600
fit
